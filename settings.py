...
BAN_MESSAGE = os.getenv("BAN_MESSAGE", "You are banned forever")
BAN_MESSAGE_ADMIN = os.getenv("BAN_MESSAGE", "User {user_name} banned forever")
PRIVATE_KEY_DANGEROUS_COMMAND = os.getenv("PRIVATE_KEY_DANGEROUS_COMMAND")
